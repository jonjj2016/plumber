export const services = [{
        ...
        title: "Унитазы",
        options: ["Монтаж напольных унитазов", "Монтаж подвесных унитазов", "Монтаж моноблочных унитазов"],
    ...
    },
    {
        icon: "",
        title: "Смесители",
        options: ["Монтаж простого смесителя", "Монтаж смесителя с донным клапаном", "Установка смесителя с душем"],
    },
    {
        icon: "",
        title: "Ванны",
        options: ["Монтаж стальной ванны", "Монтаж акриловой ванны", "Монтаж чугунной ванны"],
        ...
        title: "Раковины",
        icon: "https://cdn0.iconfinder.com/data/icons/real-estate-vol-2-4-4/48/195-512.png",
        options: ["Монтаж раковины", "Монтаж раковины «тюльпан»", "Монтаж раковины с тумбой"],
    ...
    },
    {
        ...
        options: ["Монтаж душевой кабины", "Сборка душевой кабины", "Герметизация душевой кабины"],
    }, {
        icon: "https://cdn0.iconfinder.com/data/icons/real-estate-vol-2-4-4/48/195-512.png",
        title: "Разводка труб",
    ...
    },
    {
        icon: "",
        title: "Фильтры",
        options: ["Установка фильтра питьевой воды", "Установка фильтра тонкой очистки", "Установка фильтра грубой очистки"],
    },
    {
        icon: "",
